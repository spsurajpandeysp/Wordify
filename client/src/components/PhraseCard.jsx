...
const PhraseCard = ({ 
    ...
    return (
        <div className={`compact-phrase-card ${isSelected ? 'selected' : ''}`}>
                    ...
                    <div className="card-actions-compact" onClick={(e) => e.stopPropagation()}>
                        {onSelect && (
                            <button
                                ...
                                onClick={() => onSelect({ phrase, meaning, examples, synonyms })}
                        ...
                        {onSave && (
                            <button
                                ...
                                onClick={() => onSave({ phrase, meaning, examples, synonyms })}
                        ...
                        {onDelete && (
                            <button
                                ...
                                onClick={() => {
                                    console.log('Delete button clicked in PhraseCard');
                                    onDelete();
                                }}
                                title="Delete"
                            >
            ...
            <style jsx>{`
                ...
                .compact-phrase-card:hover {
                    box-shadow: 0 4px 16px rgba(0, 0, 0, 0.15);
                    transform: translateY(-1px);
                }

                .compact-phrase-card.selected {
                    border-color: #8b5cf6;
                    background: #faf5ff;
                }
